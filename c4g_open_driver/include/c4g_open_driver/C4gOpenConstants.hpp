...
#define DEFAULT_PORT_NUMBER 1001 //< Default port number of PC-C4G socket. Left == 1001
...
{
    NO_ERROR = -1,
    SOCKET_INIT_ERROR,              /**< Error during the initialization of socket. */
    SOCKET_OPEN_ERROR,              /**< Error while opening socket. */
    SOCKET_BINDING_ERROR,           /**< Error while binding socket. */
    SOCKET_SEND_ERROR,              /**< Error while sending a packet to C4G. */
    SOCKET_RECEIVE_ERROR,           /**< Error while receiving a packet from C4G. */
    SOCKET_SET_RCV_TIMEOUT_ERROR,   /**< Error while setting the receiving timeout. */
